...
ob_start();
##########
$token = "8036072849:AAFVsjljPfxqlHMYvQZlfkX2Sih5i30VAZQ"; // توكنك
$kindi = "8036072849:AAFVsjljPfxqlHMYvQZlfkX2Sih5i30VAZQ";// توكنك

$buy = "Ali";
$userbot ="cc77nnbot";
$sudo = "7246260162"; // ايديك
$admin = "$sudo";
$idBot = "7874517202";// ايدي بوتك
$admmm = $sudo;
$ADMIN = $sudo;
$Dev = array("$sudo","7246260162");// ايديك
$Devd = "$sudo";
$tbbots = cc77nnbot;/// يوزر بوتك بدون @
 
$channel = "iraqbots2";/// يوزر قناتك بدون@
$chinnl = "$channel";
$DevUser = "@$buy"; // 
$Devch = "@$buy"; //  
$Userbot = "$tbbots"; // 
...
────────────────
⌯⁞ CH ⋙ **[ᴛᴇᴀᴍ ɴɪᴢᴋ](https://t.me/iraqbots2)** 💥
⌯⁞ CH ⋙ **[Ͳᴇᴀᴍ ʏᴇᴍᴇɴ](t.me/iraqbots2)** 🇾🇪
────────────
...
$fast = array('• اسرع واحد يرسل » { كارلوس }','• اسرع واحد يرسل » { تايكر }','• اسرع واحد يرسل » { رمضان }','• اسرع واحد يرسل » { ارنب }','• اسرع واحد يرسل » { Nazar }','• اسرع واحد يرسل » { حمود }','• اسرع واحد يرسل » { تيم كارلوس }','• اسرع واحد يرسل » { مهند }','• اسرع واحد يرسل » { سورس الجبوري }','• اسرع واحد يرسل » { ءبوايهاب }','• اسرع واحد يرسل » { الاحواز }','• اسرع واحد يرسل » { الاحوازي }','• اسرع واحد يرسل » { العراق }','• اسرع واحد يرسل » { سعوديه }');
...
if(in_array($chat_id,$game1) and $text == 'كارلوس' or $text == 'مهند'or $text == 'العراق'or $text == 'سعوديه'or $text == 'ارنب'or $text == 'Nazar' or$text == 'الاحواز' or $text == 'رمضان' or $text == 'تيم كارلوس' or $text == 'تايكر' or $text == 'حمود' or $text == 'سورس الجبوري' or $text == 'ءبوايهاب' or $text == 'الاحوازي'){
if($level == "gamew"){
$game['game'][$chat_id][$from_id] = ($game['game'][$chat_id][$from_id]+1);
file_put_contents('game.json', json_encode($game));
file_put_contents("game/$chat_id/game.txt","");
...
✵⁞ [Nizk Team](https://t.me/iraqbots2)
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌯︙[Source Channel](https://t.me/iraqbots2)\n
⌯︙[Source Install](https://t.me/iraqbots2)\n
⌯︙[Changing ID Channel](https://t.me/iraqbots2)\n
⌯︙[TEAM Source](https://t.me/iraqbots2)*\n
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
⌯︙[ConnectDeV](https://t.me/A8_jz)
",'parse_mode'=>"Markdown",
'disable_web_page_preview'=> true ,
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"- تنصيب سورس",'url'=>"https://telegram.me/cc77nnbot?start"]],
